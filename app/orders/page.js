          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <SelectContent className="bg-gray-900 border-gray-800">
                <SelectItem value="all" className="text-gray-200 hover:bg-gray-800">All Statuses</SelectItem>
                <SelectItem value="Pending" className="text-gray-200 hover:bg-gray-800">Pending</SelectItem>
                {/* ... other SelectItems ... */}
              </SelectContent>
            </Select>
          </div>
        ...
        <div className="border border-gray-800 rounded-lg overflow-hidden">
          <table className="w-full">
            <thead className="bg-gray-900 border-b border-gray-800">
              <tr>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-200">Order ID</th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-200">Customer</th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-200">Pizza Type</th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-200">Qty</th>
                <th className="px-6 py-4 text-left text-sm font-medium text-gray-200">Order Date</th>
            ...
            <tbody className="divide-y divide-gray-800">
              {filteredOrders.map((order) => (
                <tr key={order.id} className="hover:bg-gray-900/50 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-200 font-medium">{order.id}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-200">{order.customer}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-200">{order.type}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-200">{order.quantity}</td>
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-end">
              <Button type="submit" className="bg-rose-500 hover:bg-rose-600 text-gray-200">
                Add Order
              </Button>
            </div>
          </form>
